...
public class NotificationViewManager {
    ...
    class Configuration extends ContentObserver {
        ...
        private void updateSettings() {
            ...
            expandedView = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW, expandedView ? 1 : 0)
                    == 1 && !privacyMode;
            forceExpandedView = Settings.System.getInt(mContext.getContentResolver(),
                    ...
                    forceExpandedView ? 1 : 0) == 1 && !privacyMode;
    ...
    public class NotificationListenerWrapper extends INotificationListener.Stub {
        ...
        public void onNotificationPosted(final StatusBarNotification sbn) {
            ...
            boolean added = mHostView.addNotification(sbn, (screenOffAndNotCovered || mIsScreenOn)
                    && showNotification, config.forceExpandedView);
            if (added && config.wakeOnNotification && screenOffAndNotCovered && showNotification
                    && mTimeCovered == 0) {
                wakeDevice();
            }
        }
    ...
    private void registerNotificationListener() {
        if (NotificationListener == null) {
            ...
            try {
                mNotificationManager.registerListener(NotificationListener, cn,
                        UserHandle.USER_ALL);
